...
public class TupleTest {
  ...
  static
  SixTuple<Vehicle,Amphibian,String,Integer,Double,Integer> j() {
    return new
      SixTuple<Vehicle,Amphibian,String,Integer,Double,Integer>(
        new Vehicle(), new Amphibian(), "hi", 47, 11.1, 99);
  }
